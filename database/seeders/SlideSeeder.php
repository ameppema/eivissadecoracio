...
class SlideSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Slide::create([$this->columns['title'] => 'Ingeniería y Contratación.',$this->columns['descripction']=>'Con mas de 40 años en la construcción somos lideres', $this->columns['image']=>'slide/slide02_lg.jpg',$this->columns['image_mobile']=>'slide/slide02_xs.jpg',$this->columns['locale']=>'es']);
