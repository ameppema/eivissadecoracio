        ...
        <form action="" method="post" enctype="multipart/form-data" id="Form-Edit">
            ...
            <div class="modal__spanish">
                <div class="modal__title">
                    ...
                    <x-adminlte-input id="ModalTitle_ES" name="titulo_es" placeholder="Título en Español" disable-feedback value="{{old('titulo')}}"/>
                </div>
                ...
                <div class="modal__description">
                    ...
                    <x-adminlte-input id="ModalDescription_ES" name="descripcion_es" placeholder="Descripción en Español" disable-feedback value="{{old('descripcion')}}"/>
                </div>
            </div>
