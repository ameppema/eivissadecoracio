...
@section('title', 'Rehabilitaciones')

@section('content')
    <section id="header" class="header">
        
        <div class="head">
            <div class="head__image" style="background: url('storage/{{ $rehabilitaciones->imagen_principal }}') no-repeat center top/cover;" data-img-movil="background: url('storage/{{ $rehabilitaciones->imagen_movil }}')">
                <div class="slide__info">
                    <h2 class="slide__title">{{ $rehabilitaciones->titulo }}</h2>
        
                    <p class="slide__text">
                    {{ $rehabilitaciones->subtitulo }}
                    </p>
                </div>
            </div>
        </div>
