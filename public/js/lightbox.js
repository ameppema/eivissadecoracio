...
let metLightbox = {
    ...
    lightbox: function(imagen){
        ...
        propLightbox.imagenSrc = imagen.src;
        ...
        propLightbox.cuerpoDom.style.overflowX = 'hidden';
        ...
        propLightbox.modal.addEventListener('click', metLightbox.cerrarModalByoffset);
    ...
    cerrarModal: function(){
        ...
        propLightbox.cuerpoDom.style.overflowX = 'visible';
        propLightbox.cuerpoDom.style.overflowY = 'visible';
        },
    cerrarModalByoffset: function(e){
            if(!e.target.classList.contains('imagen-modal')){
